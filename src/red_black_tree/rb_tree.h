 ...
 * pase.
*/
rb_tree* init_rb_tree(coordinate coordinate);
...
/** Inserta un punto al rb-tree, puede estar repetido y sigue funcionando. */
void rb_insert(rb_tree* tree, vertex* element);

/** 
 * Busca el punto que se le pasa.
 */
vertex* rb_search(rb_tree* tree, vertex* element);
