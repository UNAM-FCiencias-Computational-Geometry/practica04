  ...
  class TestRBTree
    ...
    def self.rb_min
      ...
      raw_numbers.each do |point|
        points << Points.init_point(0.0,point.to_f,"")
      end
    ...
    def self.rb_search
      ...
      raw_numbers.each do |point|
        ...
        new_point =  Points.init_point(0.0,point.to_f,"")
