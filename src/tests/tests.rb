...
require File.expand_path(File.join(File.dirname(__FILE__), "ra_tree_tests"))
...
module Test
  ...
  def self.run
    ...
    assert("range_tree.h: two_d_range_query recibe NULL.", 
           TestRATree.two_d_range_query_on_null)
    assert("range_tree.h: two_d_range_query recibe un arbol vacío.",
           TestRATree.two_d_range_query_on_empty_tree)
    assert("range_tree.h: two_d_range_query recibe un arbol no vacio",
           TestRATree.two_d_range_query_not_empty_tree)
    puts ""
